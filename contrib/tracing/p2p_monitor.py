...
""" Interactive kvanta5d P2P network traffic monitor utilizing USDT and the
    net:inbound_message and net:outbound_message tracepoints. """

# This script demonstrates what USDT for Kvanta5 Core can enable. It uses BCC
...
def main(pid):
    ...
    kvanta5d_with_usdts.enable_probe(
