...
"""Example logging Kvanta5 Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/kvanta5d
...
def main(pid):
    ...
    b = BPF(text=program, usdt_contexts=[kvanta5d_with_usdts])
