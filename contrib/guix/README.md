...
This directory contains the files necessary to perform bootstrappable Kvanta5
Core builds.
...
To build Kvanta5 Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      Kvanta5 Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/kvanta5-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/kvanta5-core/guix.sigs).
