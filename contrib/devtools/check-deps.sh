...
declare -A LIBS
LIBS[cli]="libkvanta5_cli.a"
LIBS[common]="libkvanta5_common.a"
LIBS[consensus]="libkvanta5_consensus.a"
LIBS[crypto]="libkvanta5_crypto.a"
LIBS[node]="libkvanta5_node.a"
LIBS[util]="libkvanta5_util.a"
LIBS[wallet]="libkvanta5_wallet.a"
...
# https://github.com/kvanta5/kvanta5/issues/10102
