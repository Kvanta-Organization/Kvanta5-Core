...
def parse_args():
    argparser = argparse.ArgumentParser(description='Generate a list of kvanta5 node seed ip addresses.')
...
def main():
    ...
    # Filter out hosts with multiple kvanta5 ports, these are likely abusive
    ips = filtermultiport(ips)
    print(f'{ip_stats(ips):s} Filter out hosts with multiple kvanta5 ports', file=sys.stderr)
