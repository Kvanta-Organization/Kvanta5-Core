...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef KVANTA5_CHAINPARAMSSEEDS_H\n')
    g.write('#define KVANTA5_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the kvanta5 network\n')
    ...
    g.write('#endif // KVANTA5_CHAINPARAMSSEEDS_H\n')
