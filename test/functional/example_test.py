...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the Kvanta5TestFramework
    pass


class ExampleTest(Kvanta5TestFramework):
    # Each functional test is a subclass of the Kvanta5TestFramework class.
    ...
    def custom_method(self):
        ...
        Kvanta5TestFramework class so other tests can use it."""
