...
class InvalidAddressErrorMessageTest(Kvanta5TestFramework):
    ...
    def test_validateaddress(self):
        ...
        assert_raises_rpc_error(-1, "Return information about the given kvanta5 address.", node.validateaddress)
