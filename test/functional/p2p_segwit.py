...
class SegWitTest(Kvanta5TestFramework):
    ...
    def test_p2sh_witness(self):
        ...
        # segwit activation.  Note that older kvanta5d's that are not
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let kvanta5d fill it in.
