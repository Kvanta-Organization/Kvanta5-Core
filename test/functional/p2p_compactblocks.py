...
# TestP2PConn: A peer we use to send messages to kvanta5d, and store responses.
...
class CompactBlocksTest(Kvanta5TestFramework):
    ...
    # This test actually causes kvanta5d to (reasonably!) disconnect us, so do this last.
    ...
    # Test that kvanta5d requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for kvanta5d to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        node = self.nodes[0]
        # kvanta5d will not send blocktxn responses for blocks whose height is
