...
"""
Test starting kvanta5d with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(Kvanta5TestFramework):
    ...
    def run_test(self):
        for i, (args, expected_services) in enumerate(self.expected):
            ...
            # that kvanta5d has bound on "::1" (for RPC) and "::" (for P2P).
