...
class TxnMallTest(Kvanta5TestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 KV5:
        ...
        # First: use raw transaction API to send 1240 KV5 to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 KV5 coin each
        ...
        # Node0's balance should be starting balance, plus 50KV5 for another
        ...
        # Node0's total balance should be starting balance, plus 100KV5 for
