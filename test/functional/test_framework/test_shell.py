...
class TestShell:
    """Wrapper Class for Kvanta5TestFramework.

    The TestShell class extends the Kvanta5TestFramework
    ...
    class __TestShell(Kvanta5TestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by Kvanta5TestFramework child class.
            self.num_nodes = 1
    ...
    def __new__(cls):
        ...
        if not TestShell.instance:
            # Kvanta5TestFramework instances are supposed to be constructed with the path
