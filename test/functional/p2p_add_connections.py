...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The kvanta5d node closes feeler connections as soon as a version
...
class P2PAddConnections(Kvanta5TestFramework):
    ...
    def run_test(self):
        ...
        # kvanta5d behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that kvanta5d sends its own version prior to processing
