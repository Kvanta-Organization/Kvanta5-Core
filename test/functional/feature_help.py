...
"""Verify that starting kvanta5 with -h works as expected."""

from test_framework.test_framework import Kvanta5TestFramework
from test_framework.util import assert_equal

class HelpTest(Kvanta5TestFramework):
    ...
    def run_test(self):
        self.log.info("Start kvanta5 with -h for help text")
        ...
        self.log.info("Start kvanta5 with -version for version information")
        ...
        self.log.info("Start kvanta5d with -fakearg to make sure it does not start")
