...
By default, kvanta5d will dump mempool on shutdown and
...
class MempoolPersistTest(Kvanta5TestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent kvanta5d from writing mempool.dat to disk. Verify that `savemempool` fails")
