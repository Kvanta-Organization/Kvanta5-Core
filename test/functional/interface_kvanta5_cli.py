...
# The block reward of coinbaseoutput.nValue (50) KV5/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 KV5/block.
...
WALLET_NOT_SPECIFIED = (
    ...
    "option before the command (run \"kvanta5-cli -h\" for help or \"kvanta5-cli listwallets\" to see "
...
class TestKvanta5Cli(Kvanta5TestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `kvanta5-cli getblockchaininfo`")
        ...
        # Prevent kvanta5-cli from using existing rpcport in conf
        ...
        self.log.info("Test -getinfo and kvanta5-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and kvanta5-cli getwalletinfo return expected wallet info")
            ...
            assert_equal(Decimal(cli_get_info['Transaction fee rate (-paytxfee) (KV5/kvB)']), wallet_info['paytxfee'])
            assert_equal(Decimal(cli_get_info['Min tx relay fee rate (KV5/kvB)']), network_info['relayfee'])
            ...
            # Mine a block to confirm; adds a block reward (50 KV5) to the default wallet.
            ...
            # Test kvanta5-cli -generate with -rpcwallet in multiwallet mode.
