...
Verify that a kvanta5d node can use an external signer command.
...
class RPCSignerTest(Kvanta5TestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart kvanta5d with -signer=<cmd>',
