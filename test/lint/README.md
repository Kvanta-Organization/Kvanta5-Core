...
```sh
DOCKER_BUILDKIT=1 docker build -t kvanta5-linter --file "./ci/lint_imagefile" ./ && docker run --rm -v $(pwd):/kvanta5 -it kvanta5-linter
```
...
```
git remote add --fetch secp256k1 https://github.com/kvanta5-core/secp256k1.git
```
