...
# Copyright 2016-2017 The Kvanta5 Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test framework for kvanta5 utils.
...
def main():
    ...
    bctester(os.path.join(env_conf["SRCDIR"], "test", "util", "data"), "kvanta5-util-test.json", env_conf)
...
def bctest(testDir, testObj, buildenv):
    ...
    if testObj["exec"] == "./kvanta5-util":
        execprog = os.getenv("KVANTA5UTIL", default=execprog)
    elif testObj["exec"] == "./kvanta5-tx":
        execprog = os.getenv("KVANTA5TX", default=execprog)
    ...
    if "error_txt" in testObj:
        ...
        # That stderr is empty if no errors are expected. However, kvanta5-tx
