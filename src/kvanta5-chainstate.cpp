...
//
// The kvanta5-chainstate executable serves to surface the dependencies required
// by a program wishing to use Kvanta5 Core's consensus engine as it is right
// now.
//
// DEVELOPER NOTE: Since this is a "demo-only", experimental, etc. executable,
//                 it may diverge from Kvanta5 Core's coding style.
//
// It is part of the libkvanta5kernel project.
