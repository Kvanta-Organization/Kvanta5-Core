// Copyright (c) 2023 The Kvanta5 Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or https://www.opensource.org/licenses/mit-license.php.

#ifndef KVANTA5_ADDRESSTYPE_H
#define KVANTA5_ADDRESSTYPE_H
...
struct Kvanta5P2QRDestination : public BaseHash<uint256>
{
    Kvanta5P2QRDestination() : BaseHash() {}
    explicit Kvanta5P2QRDestination(const uint256& hash) : BaseHash(hash) {}
};
 ...
 *  * Kvanta5P2QRDestination: TxoutType::KVANTA5_P2QR destination (native Kvanta5 quantum-resistant address)
 *  * PayToAnchor: TxoutType::ANCHOR destination (P2A address)
 *  * WitnessUnknown: TxoutType::WITNESS_UNKNOWN destination (P2W??? address)
 *  A CTxDestination is the internal data type encoded in a kvanta5 address
 */
using CTxDestination = std::variant<CNoDestination, PubKeyDestination, PKHash, ScriptHash, WitnessV0ScriptHash, WitnessV0KeyHash, WitnessV1Taproot, Kvanta5P2QRDestination, PayToAnchor, WitnessUnknown>;
...
/**
 * Generate a Kvanta5 scriptPubKey for the given CTxDestination. Returns a P2PKH
 * script for a CKeyID destination, a P2SH script for a CScriptID, and an empty
 * script for CNoDestination.
 */
CScript GetScriptForDestination(const CTxDestination& dest);

#endif // KVANTA5_ADDRESSTYPE_H
