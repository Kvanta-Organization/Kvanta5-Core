...
#ifndef KVANTA5_NODE_CONNECTION_TYPES_H
#define KVANTA5_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/kvanta5-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Kvanta5’s Peer-to-Peer Network")
...
#endif // KVANTA5_NODE_CONNECTION_TYPES_H
