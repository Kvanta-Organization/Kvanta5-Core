...
#ifndef KVANTA5_NODE_MINER_H
#define KVANTA5_NODE_MINER_H
...
struct CTxMemPoolModifiedEntry {
    ...
    size_t GetP2QRAdjustedTxSize() const { return iter->GetP2QRAdjustedTxSize(); }
...
private:
    ...
    */
    ...
    bool TestPackage(uint64_t packageSize, int64_t packageSigOpsCost, uint64_t packageRawSize) const;
