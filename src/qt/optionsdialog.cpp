      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->kvanta5AtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->kvanta5AtStartup);
    ...
    ui->kvanta5AtStartup->setToolTip(ui->kvanta5AtStartup->toolTip().arg(CLIENT_NAME));
    ui->kvanta5AtStartup->setText(ui->kvanta5AtStartup->text().arg(CLIENT_NAME));

    ui->openKvanta5ConfButton->setToolTip(ui->openKvanta5ConfButton->toolTip().arg(CLIENT_NAME));
    ...
    ui->unit->setModel(new Kvanta5Units(this));
...
{
    /* Main */
    mapper->addMapping(ui->kvanta5AtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSKV5ontrols);
...
void OptionsDialog::on_openKvanta5ConfButton_clicked()
{
