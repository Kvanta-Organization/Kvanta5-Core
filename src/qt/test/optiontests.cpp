...
{
    // Test regression https://github.com/kvanta5/kvanta5/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/kvanta5-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/kvanta5-core/gui/pull/568.
    // With fListen=false in ~/.config/Kvanta5/Kvanta5-Qt.conf and all else left as default,
    // kvanta5-qt should set both -listen and -listenonion to false and start successfully.
