...
//! Entry point for Kvanta5Application tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &Kvanta5Application::windowShown, this, &AppTests::guiTests);
...
//! Entry point for Kvanta5GUI tests.
void AppTests::guiTests(Kvanta5GUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &Kvanta5GUI::consoleShown, this, &AppTests::consoleTests);
