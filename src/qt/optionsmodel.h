...
#ifndef KVANTA5_QT_OPTIONSMODEL_H
#define KVANTA5_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Kvanta5 client.
...
public:
    ...
    Kvanta5Unit getDisplayUnit() const { return m_display_kvanta5_unit; }
    QString getThirdPartyTxUrls() const { return strThirdPartyTxUrls; }
    QFont getFontForMoney() const;
    bool getCoinControlFeatures() const { return fCoinControlFeatures; }
    bool getSubFeeFromAmount() const { return m_sub_fee_from_amount; }
    bool getEnablePSKV5ontrols() const { return m_enable_psbt_controls; }
...
private:
    ...
    QString language;
    Kvanta5Unit m_display_kvanta5_unit;
...
Q_SIGNALS:
    void displayUnitChanged(Kvanta5Unit unit);
...
#endif // KVANTA5_QT_OPTIONSMODEL_H
