...
#ifndef KVANTA5_QT_TRANSACTIONVIEW_H
#define KVANTA5_QT_TRANSACTIONVIEW_H
...
private:
    ...
    QAction *copyP2QRMiningAddressAction{nullptr};
...
#endif // KVANTA5_QT_TRANSACTIONVIEW_H
