...
#ifndef KVANTA5_QT_GUIUTIL_H
#define KVANTA5_QT_GUIUTIL_H
...
/** Utility functions used by the Kvanta5 Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "kvanta5:" URI into recipient object, return true on successful parsing
