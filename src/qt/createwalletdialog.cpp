    ...
    ui(new Ui::CreateWalletDialog)
{
    ...
    connect(ui->encrypt_wallet_checkbox, &QCheckBox::toggled, [this](bool checked) {
        ...
        // Multi-Sig Vault Wallet is independent of encryption.
        // Users may create encrypted multisig vault wallets.
        ...
        // When the external_signer_checkbox is disabled, uncheck it.
    ...
    connect(ui->external_signer_checkbox, &QCheckBox::toggled, [this](bool checked) {
        ...
        // Multi-Sig Vault Wallet is independent of external signer hardware.
        // Kvanta5 vault signing will use export/import signing packages, not hardware signer dependency.
    ...
    connect(ui->disable_privkeys_checkbox, &QCheckBox::toggled, [this](bool checked) {
        ...
        // Multi-Sig Vault Wallet is independent of disabled private keys.
        // Later this can support coordinator/watch-only multisig wallets.
    ...
    connect(ui->blank_wallet_checkbox, &QCheckBox::toggled, [this](bool checked) {
        ...
        // Multi-Sig Vault Wallet is independent of blank-wallet mode.
        // A blank vault wallet can be useful for importing/coordinating policies later.
    });
...
void CreateWalletDialog::setSigners(const std::vector<std::unique_ptr<interfaces::ExternalSigner>>& signers)
{
    ...
    if (m_has_signers) {
        ...
        // Do not touch multisig_vault_wallet_checkbox here.
        // Kvanta5 Multi-Sig Vault Wallet is not an external signer feature.
...
bool CreateWalletDialog::isMultisigVaultWalletChecked() const
{
    return ui->multisig_vault_wallet_checkbox->isChecked();
}
