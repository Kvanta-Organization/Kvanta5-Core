...
#ifndef KVANTA5_QT_BITCOINGUI_H
#define KVANTA5_QT_BITCOINGUI_H
...
/**
  Kvanta5 GUI main class. This class represents the main window of the Kvanta5 UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class Kvanta5GUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit Kvanta5GUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~Kvanta5GUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a kvanta5 wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, Kvanta5Unit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Switch to Mu-Sig Vaults Page */ 
    void gotoVaultsPage();
    /** Show Sign/Verify Message dialog and switch to sign message tab */
    void gotoSignMessageTab(QString addr = "");
    /** Show Sign/Verify Message dialog and switch to verify message tab */
    void gotoVerifyMessageTab(QString addr = "");
    /** Load Partially Signed Kvanta5 Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(Kvanta5Unit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // KVANTA5_QT_BITCOINGUI_H
