...
#ifndef KVANTA5_ARITH_UINT256_H
#define KVANTA5_ARITH_UINT256_H
...
public:
     ...
     *
     * Kvanta5 only uses this "compact" format for encoding difficulty
