...
#ifndef KVANTA5_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
#define KVANTA5_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
...
#endif // KVANTA5_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
