...
static void WalletCreate(CWallet* wallet_instance, uint64_t wallet_creation_flags)
{
    ...
    if (wallet_instance->IsWalletFlagSet(WALLET_FLAG_DESCRIPTORS)) {
        ...
        tfm::format(std::cout, "Initializing Kvanta5 wallet...\n");
        wallet_instance->TopUpKeyPool();
    } else {
        /*
         * Kvanta5 non-descriptor wallets do not activate Bitcoin's
         * LegacyScriptPubKeyMan for address/key generation.
         *
         * Receiving and change keys are generated by the wallet-native
         * P2QR manager. The Bitcoin legacy SPKM is retained only for
         * compatibility/migration of historical wallet records.
         */
        wallet_instance->GetOrCreateKvanta5P2QRScriptPubKeyMan();
    }
}
