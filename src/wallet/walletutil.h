...
#ifndef KVANTA5_WALLET_WALLETUTIL_H
#define KVANTA5_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! kvanta5 from opening the wallet, thinking it was newly created, and
...
#endif // KVANTA5_WALLET_WALLETUTIL_H
