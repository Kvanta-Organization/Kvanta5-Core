...
static RPCHelpMan loadwallet()
{
    return RPCHelpMan{"loadwallet",
                ...
                "\nNote that all wallet command-line options used when starting kvanta5d will be"
...
Span<const CRPCCommand> GetWalletRPCCommands()
{
    static const CRPCCommand commands[]{
        ...
        {"wallet", &dumpprivkey},
        {"wallet", &dumpkvanta5p2qrseed},
        {"wallet", &dumpkvanta5vaultbackup},
        {"wallet", &importkvanta5vaultbackup},
        {"wallet", &getnewkvanta5p2qraddress},
        {"wallet", &getnewkvanta5p2qrminingaddress},
        {"wallet", &importkvanta5p2qrseed},
        {"wallet", &dumpwallet},
