...
#ifndef KVANTA5_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define KVANTA5_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // KVANTA5_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
