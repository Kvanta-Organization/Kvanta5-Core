...
#ifndef KVANTA5_WALLET_TRANSACTION_H
#define KVANTA5_WALLET_TRANSACTION_H
...
public:
     ...
     * on this kvanta5 node, and set to 0 for transactions that were created
...
#endif // KVANTA5_WALLET_TRANSACTION_H
