...
#ifndef KVANTA5_WALLET_WALLETDB_H
#define KVANTA5_WALLET_WALLETDB_H
...
// Database record types associated with LegacyScriptPubKeyMan compatibility data.
...
#endif // KVANTA5_WALLET_WALLETDB_H
