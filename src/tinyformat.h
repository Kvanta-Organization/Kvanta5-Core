...
#include <algorithm>
#include <attributes.h> // Added for Kvanta5 Core
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for Kvanta5 Core
#include <util/string.h> // Added for Kvanta5 Core
...
// Added for Kvanta5 Core. Similar to std::runtime_format from C++26.
...
// Added for Kvanta5 Core. Wrapper for checking format strings at compile time.
