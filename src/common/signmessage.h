...
#ifndef KVANTA5_COMMON_SIGNMESSAGE_H
#define KVANTA5_COMMON_SIGNMESSAGE_H
 ...
 * @param[in] address Signer's kvanta5 address, it must refer to a public key.
...
#endif // KVANTA5_COMMON_SIGNMESSAGE_H
