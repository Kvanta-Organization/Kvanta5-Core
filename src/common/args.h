...
#ifndef KVANTA5_COMMON_ARGS_H
#define KVANTA5_COMMON_ARGS_H
...
extern const char * const KVANTA5_CONF_FILENAME;
extern const char * const KVANTA5_SETTINGS_FILENAME;
...
private:
    ...
    /**
     * Return -regtest/-signet/-testnet5/-chain= setting as a ChainType enum if a
