...
#ifndef KVANTA5_SCRIPT_INTERPRETER_H
#define KVANTA5_SCRIPT_INTERPRETER_H
...
enum : uint32_t {
    ...
    // Verify native KV5 P2QR ML-DSA-87 spends.
    //
    // This hard-fork validation flag is enabled by block height through
    // GetBlockScriptFlags(), not by static policy flags.
    SCRIPT_VERIFY_KVANTA5_P2QR = (1U << 21),
...
struct PrecomputedTransactionData
{
    ...
    // These are single-SHA256, see https://github.com/kvanta5/bips/blob/master/bip-0341.mediawiki#cite_note-16.
...
#endif // KVANTA5_SCRIPT_INTERPRETER_H
