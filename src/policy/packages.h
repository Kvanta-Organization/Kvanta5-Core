...
#ifndef KVANTA5_POLICY_PACKAGES_H
#define KVANTA5_POLICY_PACKAGES_H
...
static constexpr int32_t MAX_PACKAGE_WEIGHT{MAX_BLOCK_WEIGHT};
...
#endif // KVANTA5_POLICY_PACKAGES_H
