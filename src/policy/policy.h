...
#ifndef KVANTA5_POLICY_POLICY_H
#define KVANTA5_POLICY_POLICY_H
...
/**
 * Maximum standard transaction weight for oversized P2QR consolidation,
 * migration, or institutional fanout transactions.
 *
 * This larger policy limit is only applied after prevouts are available and
 * policy confirms the transaction spends Kvanta5 P2QR or P2SH-wrapped P2QR
 * inputs. Normal non-P2QR transactions remain capped by MAX_STANDARD_TX_WEIGHT.
 *
 * This is relay/mining policy only. Consensus block weight remains the real
 * upper bound.
 */
static constexpr int32_t MAX_STANDARD_P2QR_TX_WEIGHT{MAX_BLOCK_WEIGHT};
...
static constexpr unsigned int DEFAULT_ANCESTOR_SIZE_LIMIT_KVB{1000};
/** Default for -limitdescendantcount, max number of in-mempool descendants */
static constexpr unsigned int DEFAULT_DESCENDANT_LIMIT{25};
/** Default for -limitdescendantsize, maximum kilobytes of in-mempool descendants */
static constexpr unsigned int DEFAULT_DESCENDANT_SIZE_LIMIT_KVB{1000};
/** KVANTA5_P2QR fee-policy virtual size per P2QR input.
 *
 * This prices native/P2SH-carried KVANTA5_P2QR spends like a normal modern
 * SegWit-style input for fee policy and wallet fee estimation.
 *
 * This must NOT be used for:
 *   - consensus block weight
 *   - serialized transaction size
 *   - standard transaction max weight
 *   - validation cost accounting
 */
static constexpr int64_t P2QR_POLICY_FEE_VBYTES_PER_INPUT{68};
...
/** Compute fee-policy vsize with KVANTA5_P2QR signature envelopes discounted.
 *
 * Real tx size/weight is unchanged. This only affects fee policy.
 */
