 ...
 * for both kvanta5d and kvanta5-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string UA_NAME("Kvanta5");


#include <kvanta5-build-info.h>
// The <kvanta5-build-info.h>, which is generated by the build environment (cmake/script/GenerateBuildInfo.cmake),
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/kvanta5/bips/blob/master/bip-0014.mediawiki)
 */
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Make sure Kvanta5 Core copyright is not removed by accident
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/Kvanta-Organization/Kvanta5-Core>";
