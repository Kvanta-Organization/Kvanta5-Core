...
#ifndef KVANTA5_TEST_SCRIPTNUM10_H
#define KVANTA5_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Kvanta5 Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // KVANTA5_TEST_SCRIPTNUM10_H
