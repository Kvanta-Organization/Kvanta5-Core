...
{
    // Original BTC WIF payload, decoded manually:
    // 5Kg1gnAjaLfKiwhhPpGS3QfRg2m6awQvaj98JCZBZQ5SuS2F15C
    //
    // Do not use DecodeSecret() here: Kvanta5 has different WIF prefixes.
    // This test is for bloom filter key insertion/serialization, not Base58 key I/O.
    const auto key_bytes = ParseHex("f49addfd726a59abde172c86452f5f73038a02f4415878dc14934175e8418aff");
