...
bool ExtractDestination(const CScript& scriptPubKey, CTxDestination& addressRet)
{
    ...
    case TxoutType::WITNESS_V1_TAPROOT: {
        ...
        Kvanta5P2QRDestination p2qr;
        std::copy(vSolutions[0].begin(), vSolutions[0].end(), p2qr.begin());
        addressRet = p2qr;
        return true;
    }
...
public:
    ...
    CScript operator()(const Kvanta5P2QRDestination& p2qr) const
    {
        return CScript() << OP_KVANTA5_P2QR << ToByteVector(p2qr);
    }
...
public:
    ...
    bool operator()(const Kvanta5P2QRDestination& dest) const { return true; }
