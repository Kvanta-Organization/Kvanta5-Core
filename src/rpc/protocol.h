...
#ifndef KVANTA5_RPC_PROTOCOL_H
#define KVANTA5_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in kvanta5d
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Kvanta5 is not connected
