...
#ifndef KVANTA5_RPC_UTIL_H
#define KVANTA5_RPC_UTIL_H
...
/**
 * Parse a json number or string, denoting KV5/kvB, into a CFeeRate (sat/kvB).
 * Reject negative values or rates larger than 1KV5/kvB.
 */
