 ...
 * or from the Kvanta5 default estimation window if lookup is -1.
 ...
 *
 * Kvanta5 note:
 * This is display/RPC estimation only. It is not consensus logic.
 * Do not use single-block deltas for visible network hashrate because 1s/6s/10s blocks produce fake spikes.
 */
static UniValue GetNetworkHashPS(int lookup, int height, const CChain& active_chain)
{
    static constexpr int KVANTA5_HASHRATE_LOOKBACK = 24;
    ...
    /*
     * Kvanta5 uses fast blocks and DGW-style retargeting.
     *
     * Bitcoin Core's historical default behavior allows very small lookup windows,
     * including 1 block. That makes explorer/RPC hashrate estimates explode whenever
     * a lucky fast block lands.
     *
     * Clamp visible hashrate estimation to a stable rolling window. This does not
     * affect PoW, nBits, chainwork, validation, or consensus.
     */
    if (lookup == -1 || lookup < KVANTA5_HASHRATE_LOOKBACK) {
        lookup = KVANTA5_HASHRATE_LOOKBACK;
    }
    ...
    for (int i = 0; i < lookup && pb0->pprev != nullptr; ++i) {
        pb0 = pb0->pprev;
    }

    if (pb0 == nullptr || pb0 == pb) {
        return 0;
    }

    /*
     * Match the DA's clock source for the estimate, without changing DA itself.
     * Fall back to raw block time only if MTP is unusable on weird early-chain data.
     */
    int64_t timeDiff = pb->GetMedianTimePast() - pb0->GetMedianTimePast();

    if (timeDiff <= 0) {
        timeDiff = pb->GetBlockTime() - pb0->GetBlockTime();
    }
...
static RPCHelpMan generatetodescriptor()
{
    return RPCHelpMan{
        ...
        "Mine to a specified descriptor and return the block hashes.",
        {
            ...
            {"descriptor", RPCArg::Type::STR, RPCArg::Optional::NO, "The descriptor to send the newly generated kvanta5 to."},
        ...
        "Mine to a specified address and return the block hashes.",
         {
             ...
             {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The address to send the newly generated kvanta5 to."},
             {"maxtries", RPCArg::Type::NUM, RPCArg::Default{DEFAULT_MAX_TRIES}, "How many iterations to try."},
         },
         RPCResult{
             RPCResult::Type::ARR, "", "hashes of blocks generated",
         ...
         RPCExamples{
            ...
            + "If you are using the " CLIENT_NAME " wallet, you can get a new address to send the newly generated kvanta5 to with:\n"
...
static RPCHelpMan generateblock()
{
    return RPCHelpMan{"generateblock",
        ...
        {
            {"output", RPCArg::Type::STR, RPCArg::Optional::NO, "The address or descriptor to send the newly generated kvanta5 to."},
...
// NOTE: Unlike wallet RPC (which use KV5 values), mining RPCs follow GBT (BIP 22) in using satoshi amounts
...
static RPCHelpMan getblocktemplate()
{
    return RPCHelpMan{"getblocktemplate",
        ...
        "    https://github.com/kvanta5/bips/blob/master/bip-0022.mediawiki\n"
        "    https://github.com/kvanta5/bips/blob/master/bip-0023.mediawiki\n"
        "    https://github.com/kvanta5/bips/blob/master/bip-0009.mediawiki#getblocktemplate_changes\n"
        "    https://github.com/kvanta5/bips/blob/master/bip-0145.mediawiki\n",
        {
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
     ...
     * Kvanta5:
     *
     * SegWit/Taproot/witness outputs are forbidden by consensus.
     * Do not require GBT clients to advertise segwit support.
     */
        ...
        (mempool.GetTransactionsUpdated() != nTransactionsUpdatedLast && GetTime() - time_start > 5))
    {
        ...
        /*
         * Kvanta5 strict-output consensus requires every transaction output,
         * including the placeholder coinbase used while assembling a GBT
         * template, to be either native P2QR or wrapped P2SH-compatible.
         *
         * getblocktemplate does not know the pool's final coinbase payout
         * script here. Pools construct their own coinbase from the returned
         * template fields.
         *
         * Use a consensus-valid wrapped P2SH placeholder only so
         * CreateNewBlock/TestBlockValidity can build a valid template.
         *
         * Submitted blocks are still consensus-checked normally. If a miner
         * submits a real coinbase with anything other than native P2QR or
         * wrapped P2SH, upgraded Kvanta5 nodes reject it.
         */
        const CScript kvanta5_gbt_dummy_coinbase_script =
            CScript() << OP_HASH160 << std::vector<unsigned char>(20, 0x00) << OP_EQUAL;

        // Create new block
        block_template = miner.createNewBlock({.coinbase_output_script = kvanta5_gbt_dummy_coinbase_script});
        CHECK_NONFATAL(block_template);
    ...
    // Kvanta5 does not advertise segwit in GBT rules.
    ...
    if (consensusParams.signet_blocks) {
     ...
     /*
     * Kvanta5 does not expose default_witness_commitment.
     *
     * Bitcoin-style witness commitments are OP_RETURN outputs, and Kvanta5
     * consensus rejects OP_RETURN/non-P2QR/non-wrapped outputs.
     */
...
static RPCHelpMan submitblock()
{
    ...
    return RPCHelpMan{"submitblock",
        ...
        "See https://en.kvanta5.it/wiki/BIP_0022 for full specification.\n",
        {
