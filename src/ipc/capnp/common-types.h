...
#ifndef KVANTA5_IPC_CAPNP_COMMON_TYPES_H
#define KVANTA5_IPC_CAPNP_COMMON_TYPES_H
...
//! needed to pass transaction objects between kvanta5 processes.
...
//! Functions to serialize / deserialize common kvanta5 types.
namespace mp {
...
#endif // KVANTA5_IPC_CAPNP_COMMON_TYPES_H
