 ...
 */
#ifndef KVANTA5_TORCONTROL_H
#define KVANTA5_TORCONTROL_H
...
constexpr int DEFAULT_TOR_CONTROL_PORT = 9058;
...
/****** Kvanta5 specific TorController implementation ********/
