...
#ifndef KVANTA5_INTERFACES_INIT_H
#define KVANTA5_INTERFACES_INIT_H
...
//! (kvanta5-gui, kvanta5-node, kvanta5-wallet, kvanta5d, kvanta5-qt) and each
...
#endif // KVANTA5_INTERFACES_INIT_H
