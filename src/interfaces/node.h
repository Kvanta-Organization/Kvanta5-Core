...
#ifndef KVANTA5_INTERFACES_NODE_H
#define KVANTA5_INTERFACES_NODE_H
...
//! Top-level interface for a kvanta5 node (kvanta5d process).
class Node
{
public:
    ...
    //! Return setting value from <datadir>/settings.json or kvanta5.conf.
...
#endif // KVANTA5_INTERFACES_NODE_H
