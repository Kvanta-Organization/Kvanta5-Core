...
#ifndef KVANTA5_PROTOCOL_H
#define KVANTA5_PROTOCOL_H
...
/**
 * Kvanta5 protocol message types. When adding new message types, don't forget
...
enum ServiceFlags : uint64_t {
    ...
    // set by all Kvanta5 Core non pruned nodes, and is unset by SPV clients or other light clients.
    NODE_NETWORK = (1 << 0),
    ...
    // kvanta5-development mailing list. Remember that service bits are just
