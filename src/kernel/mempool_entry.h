...
#ifndef KVANTA5_KERNEL_MEMPOOL_ENTRY_H
#define KVANTA5_KERNEL_MEMPOOL_ENTRY_H
...
private:
    ...
    const int32_t nP2QRAdjustedTxWeight; //!< Adjusted TX weights for P2QR transactions
...
public:
    CTxMemPoolEntry(const CTransactionRef& tx, CAmount fee,
                ...
                int64_t p2qr_adjusted_tx_weight = -1)
        : tx{tx},
          nFee{fee},
          nTxWeight{GetTransactionWeight(*tx)},
          nP2QRAdjustedTxWeight{static_cast<int32_t>(p2qr_adjusted_tx_weight > 0 ? p2qr_adjusted_tx_weight : GetTransactionWeight(*tx))},
    ...
    int32_t GetP2QRAdjustedTxWeight() const { return nP2QRAdjustedTxWeight; }

    int32_t GetP2QRAdjustedTxSize() const
    {
    return (nP2QRAdjustedTxWeight + WITNESS_SCALE_FACTOR - 1) / WITNESS_SCALE_FACTOR;
    }
...
#endif // KVANTA5_KERNEL_MEMPOOL_ENTRY_H
