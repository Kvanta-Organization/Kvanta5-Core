...
#ifndef KVANTA5_KERNEL_MEMPOOL_OPTIONS_H
#define KVANTA5_KERNEL_MEMPOOL_OPTIONS_H
 ...
 *
 * Kvanta5 supports larger blocks and much larger P2QR transaction payloads
 * than Bitcoin. Bitcoin's 300 MB default is too tight for early miner/pool
 * operation, large-block relay testing, and normal P2QR mempool churn.
 *
 * Low-memory nodes can still override this with -maxmempool=<MB>.
 */
static constexpr unsigned int DEFAULT_MAX_MEMPOOL_SIZE_MB{1000};
...
#endif // KVANTA5_KERNEL_MEMPOOL_OPTIONS_H
