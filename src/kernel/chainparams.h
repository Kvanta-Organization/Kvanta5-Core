...
#ifndef KVANTA5_KERNEL_CHAINPARAMS_H
#define KVANTA5_KERNEL_CHAINPARAMS_H
...
public:
    ...
    const std::string& Bech32QRHRP() const { return bech32_qr_hrp; }
    ...
    static std::unique_ptr<const CChainParams> TestNet5();
...
#endif // KVANTA5_KERNEL_CHAINPARAMS_H
