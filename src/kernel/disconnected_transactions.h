...
#ifndef KVANTA5_KERNEL_DISCONNECTED_TRANSACTIONS_H
#define KVANTA5_KERNEL_DISCONNECTED_TRANSACTIONS_H
...
/*
 * Kvanta5 disconnected transaction pool.
 *
 * This pool temporarily holds transactions from disconnected blocks during
 * reorg handling so they can be reconsidered for the mempool.
 *
 * Bitcoin's 20 MB default is too small for Kvanta5 large-block operation.
 */
static const unsigned int MAX_DISCONNECTED_TX_POOL_BYTES{256'000'000};
/**
...
#endif // KVANTA5_KERNEL_DISCONNECTED_TRANSACTIONS_H
