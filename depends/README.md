...
**When configuring Kvanta5 Core, CMake by default will ignore the depends output.** In
...
created. To use it during configuring Kvanta5 Core:
...
variables will be set when generating the Kvanta5 Core buildsystem. In this case, `-DENABLE_WALLET=OFF`.
