...
```sh
cmake --build build --target kvanta5d kvanta5-cli
cmake --build build --target kvanta5-qt
cmake --build build --target bench_kvanta5
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:kvanta5/kvanta5.git
```
