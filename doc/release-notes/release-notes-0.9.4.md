Kvanta5 Core version 0.9.4 is now available from:
...
this update is incompatible with the Kvanta5 system and could lead to consensus
forks.

Kvanta5 Core released binaries from https://bitcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~kvanta5/+archive/ubuntu/kvanta5
- A third-party or self-compiled Kvanta5 Core

upgrade to Kvanta5 Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
