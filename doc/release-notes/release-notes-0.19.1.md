...
Kvanta5 Core version 0.19.1 is now available from:

  <https://bitcoincore.org/bin/kvanta5-core-0.19.1/>
...
From Kvanta5 Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Kvanta5 Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Kvanta5 Core does not yet change appearance when
...
- #17488 fix "kvanta5d already running" warnings on macOS (fanquake)
