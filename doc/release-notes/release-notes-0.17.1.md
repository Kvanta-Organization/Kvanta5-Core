...
When kvanta5 is configured with the `-deprecatedrpc=accounts` setting, specifying
...
- #14698 `ec71f06` Add kvanta5-tx.exe into Windows installer (ken2812221)
