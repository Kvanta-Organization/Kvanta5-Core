...
Kvanta5 Core version 0.21.1 is now available from:

  <https://bitcoincore.org/bin/kvanta5-core-0.21.1/>
...
fungibility of all kvanta5s. Spenders will enjoy lower fees and the
...
The addition of taproot-related features to Kvanta5 Core's wallet is
...
- Technical specifications
  - [BIP340 Schnorr signatures for secp256k1](https://github.com/kvanta5/bips/blob/master/bip-0340.mediawiki) 
  - [BIP341 Taproot: SegWit version 1 spending rules](https://github.com/kvanta5/bips/blob/master/bip-0341.mediawiki)
  - [BIP342 Validation of Taproot scripts](https://github.com/kvanta5/bips/blob/master/bip-0342.mediawiki)

- Popular articles;
  - [Taproot Is Coming: What It Is, and How It Will Benefit Kvanta5](https://kvanta5magazine.com/technical/taproot-coming-what-it-and-how-it-will-benefit-kvanta5)
  - [What do Schnorr Signatures Mean for Kvanta5?](https://academy.binance.com/en/articles/what-do-schnorr-signatures-mean-for-kvanta5)
...
- Development history overview
  - [Taproot](https://kvanta5ops.org/en/topics/taproot/)
  - [Schnorr signatures](https://kvanta5ops.org/en/topics/schnorr-signatures/)
  - [Tapscript](https://kvanta5ops.org/en/topics/tapscript/)
  - [Soft fork activation](https://kvanta5ops.org/en/topics/soft-fork-activation/)

- Other
  - [Questions and answers related to taproot](https://kvanta5.stackexchange.com/questions/tagged/taproot)
...
- Due to [BIP 350](https://github.com/kvanta5/bips/blob/master/bip-0350.mediawiki)
  ...
  (e.g. through [BIP 341](https://github.com/kvanta5/bips/blob/master/bip-0341.mediawiki)).
...
### Documentation
- #21384 add signet to kvanta5.conf documentation (jonatack)
