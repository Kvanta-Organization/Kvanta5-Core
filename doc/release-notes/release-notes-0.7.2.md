Kvanta5 version 0.7.2 is now available from:
  http://sourceforge.net/projects/kvanta5/files/Kvanta5/kvanta5-0.7.2
...
* Fix use-after-free problems in initialization and shutdown, the latter of
  which caused Kvanta5-Qt to crash on Windows when exiting.
