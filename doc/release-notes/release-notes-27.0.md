Kvanta5 Core version 27.0 is now available from:

  <https://bitcoincore.org/bin/kvanta5-core-27.0/>
...
- libkvanta5consensus is deprecated and will be removed for v28. This library has
  ...
  In the future, libkvanta5kernel will provide a much more useful API that is
...
- A C++20 capable compiler is now required to build Kvanta5 Core. (#28349)
...
- Various fixes to prevent issues where subsequent instances of Kvanta5 Core would
