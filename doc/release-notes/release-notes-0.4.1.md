Kvanta5 version 0.4.1 is now available for download at:
http://sourceforge.net/projects/kvanta5/files/Kvanta5/kvanta5-0.4.1/
...
If you have a previously encrypted wallet.dat, the first time you run wxkvanta5 or kvanta5d the wallet will be rewritten, Kvanta5 will
...
wxKvanta5: new address visible on main window
