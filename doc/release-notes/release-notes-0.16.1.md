Kvanta5 Core version 0.16.1 is now available from:

  <https://bitcoincore.org/bin/kvanta5-core-0.16.1/>
...
- #12843 `df38b13` Test starting kvanta5d with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure kvanta5d processes are cleaned up when tests end (sdaftuar)
