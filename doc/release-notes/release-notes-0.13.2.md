Kvanta5 Core version 0.13.2 is now available from:

  <https://bitcoin.org/bin/kvanta5-core-0.13.2/>
...
- #8908 `4a974b2` Update kvanta5-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow kvanta5-tx to create v2 transactions (btcdrak)
