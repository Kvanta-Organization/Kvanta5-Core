Kvanta5 Core version 0.10.4 is now available from:

  <https://bitcoin.org/bin/kvanta5-core-0.10.4/>
...
- #6953 `43c2789` Split kvanta5-tx into its own package
- #6953 `dfe0d4d` Include kvanta5-tx binary on Debian/Ubuntu
