Kvanta5-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/kvanta5/files/Kvanta5/kvanta5-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Kvanta5
...
New/changed settings (command-line or kvanta5.conf file)
--------------------------------------------------------
