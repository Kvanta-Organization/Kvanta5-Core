Kvanta5 Core version *0.14.3* is now available from:

  <https://bitcoin.org/bin/kvanta5-core-0.14.3/>
...
Kvanta5 Core versions 0.14.0 up to 0.16.2. It is recommended to upgrade any of
...
- #10451 `3612219` contrib/init/kvanta5d.openrcconf: Don't disable wallet by default (Luke Dashjr)
