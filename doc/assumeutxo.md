...
Assumeutxo is a feature that allows fast bootstrapping of a validating kvanta5d
instance.
...
```
$ kvanta5-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ kvanta5-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
